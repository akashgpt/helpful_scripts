...
# __conda_setup="$('/usr/licensed/anaconda3/2025.12/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
# if [ $? -eq 0 ]; then
#     eval "$__conda_setup"
# else
#     if [ -f "/usr/licensed/anaconda3/2025.12/etc/profile.d/conda.sh" ]; then
#         . "/usr/licensed/anaconda3/2025.12/etc/profile.d/conda.sh"
#     else
#         export PATH="/usr/licensed/anaconda3/2025.12/bin:$PATH"
#     fi
# fi
# unset __conda_setup
# # <<< conda initialize <<<
