...
**Status as of 2026-05-18 10:05 CDT:** 3 RUNNING · 4 PENDING · 2 recently COMPLETED
...
| ---------- | ---------- | -------------------------------------- | ------- | ---------------- | ---------------------- |
| `18313922` | `se_bal2x` | `variant_train_se_e2_a_TF_balanced_2x` | RUNNING | `14:45:13`       | 1 A100 GPU, 1 CPU, 48G |
| `18313923` | `se_big5x` | `variant_train_se_e2_a_TF_big5x`       | RUNNING | `14:43:20`       | 1 A100 GPU, 1 CPU, 64G |
| `18313924` | `se_bal5x` | `variant_train_se_e2_a_TF_balanced_5x` | RUNNING | `14:42:06`       | 1 A100 GPU, 1 CPU, 64G |
...
| `18313925` | `se_fit5x` | `variant_train_se_e2_a_TF_fit_deep5x` | COMPLETED | `05:30:40` | 1 A100 GPU, 1 CPU, 64G |
...
All four were pending with reason `Priority` at the status check.
...
- For `se_e2_a` intermediates:
  - Wait for `balanced_2x`, `big5x`, and `balanced_5x` to complete or fail.
  - Validate completed models on the copied `71MgSiO3_5He` held-out train/test sets.
