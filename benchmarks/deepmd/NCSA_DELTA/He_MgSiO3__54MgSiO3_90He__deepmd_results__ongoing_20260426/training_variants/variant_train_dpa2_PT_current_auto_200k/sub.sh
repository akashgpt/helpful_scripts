...
cp -f "$SHARED/train_dpa2_current_auto_200k.json" "$HERE/input.json"
cd "$HERE"

echo "=== [$(date)] PT DPA-2 diagnostic: old DPA-2 architecture with auto neighbor selection ==="
