...
#SBATCH --job-name=train_dpa2_pt_big_strip
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
cp -f "$SHARED/train_dpa2_big_strip.json" "$HERE/input.json"
cd "$HERE"

echo "=== [$(date)] PT training (DPA-2 BIG strip-mode, 1,000,000 steps) ==="
