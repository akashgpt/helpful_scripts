...
cp -f "$SHARED/train_se_e2_a_both_deep2x.json" "$HERE/input.json"
cd "$HERE"

echo "=== [$(date)] TF training (se_e2_a descriptor+fitting depth 2x, 1,000,000 steps) ==="
