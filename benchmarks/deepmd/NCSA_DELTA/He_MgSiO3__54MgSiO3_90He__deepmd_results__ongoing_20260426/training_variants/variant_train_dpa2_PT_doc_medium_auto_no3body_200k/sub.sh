...
cp -f "$SHARED/train_dpa2_doc_medium_auto_no3body_200k.json" "$HERE/input.json"
cd "$HERE"

echo "=== [$(date)] PT DPA-2 diagnostic: official-medium-style DPA-2 without the three-body repinit block ==="
