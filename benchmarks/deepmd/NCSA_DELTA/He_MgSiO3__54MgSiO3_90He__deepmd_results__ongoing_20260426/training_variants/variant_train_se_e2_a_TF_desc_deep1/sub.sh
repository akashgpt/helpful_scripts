...
#SBATCH --job-name=train_se_tf_ddeep1
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
cp -f "$SHARED/train_se_e2_a_desc_deep1.json" "$HERE/input.json"
cd "$HERE"

echo "=== [$(date)] TF training (se_e2_a descriptor-deep1, 1,000,000 steps) ==="
