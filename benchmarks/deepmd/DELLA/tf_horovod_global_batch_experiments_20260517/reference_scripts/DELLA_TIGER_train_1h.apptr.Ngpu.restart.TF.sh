...
script_path="${ALCHEMY_RESTART_SCRIPT_PATH:-${PWD}/train_1h.apptr.Ngpu.restart.TF.sh}"
...
load_runtime() {
	...
	conda activate "${ALCHEMY_CONDA_ENV:-ALCHEMY_env}"
	set -u
}
