...
#SBATCH --output=/scratch/gpfs/BURROWS/akashgpt/qmd_data/MgSiOFe__R2SCAN/test/slurm_mgsiofe_parallel20_%j.out
#SBATCH --error=/scratch/gpfs/BURROWS/akashgpt/qmd_data/MgSiOFe__R2SCAN/test/slurm_mgsiofe_parallel20_%j.err
