...
from mc_error import (
    monte_carlo_error, monte_carlo_error_asymmetric,
    monte_carlo_error_asymmetric_w_bounds,
    monte_carlo_error_asymmetric_w_io_bounds,
    monte_carlo_error_asymmetric_w_io_bounds_vectorized_outputs)
...
num_array_X = 100             # Number of points in the log-spaced X_{secondary_species} array (mole fraction grid)
max_array_X = 0.2             # Upper limit of X_{secondary_species} grid  (corresponds to a wt fraction of 0.1)
...
TEMPERATURES_TO_REMOVE  = [10400, 7200, 5200]  # T values to exclude
