...
num_array_X=1000  # number of points in the log-spaced array for X_{secondary_species}
max_array_X=16/64 #100/109  # maximum value of X_{secondary_species} (corresponds to a wt fraction of 0.1)
...
if SCRIPT_MODE <= 0:
    ...
    for i, row in df_superset.iterrows():
        ...
        def fn_for_all_v2(X_in_MgSiO3, slope_MgSiO3, intercept_MgSiO3, slope_Fe, intercept_Fe, T):
            ...
            # concatenate the outputs into a single array
            stacked_output = np.stack([Xw_in_MgSiO3, D_wt, KD_prime, KD], axis=1)
            return stacked_output
...
if PLOT_MODE == 8 or PLOT_MODE < 0:
    ...
    for i, row in df_superset.iterrows():
        ...
        axes_1[i_axes].fill_between(
            ...
            array_KD_lower,
            array_KD_upper,
            alpha=0.2, label='K$_D$ error range',
        ...
        axes_3[i_axes].fill_between(
            ...
            array_D_wt_lower,
            array_D_wt_upper,
            alpha=0.2, label='D$_{wt}$ error range',
        ...
        axes_5[i_axes].fill_between(
            ...
            array_Xw_lower,
            array_Xw_upper,
            alpha=0.2, label='X$_{w}$ error range',
    ...
    fig_2.savefig(f"array__KD_prime_vs_X.png", dpi=300)
