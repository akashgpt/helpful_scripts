...
# ----------------------------------------------------------------------------------
# Create FeH Unit Cell (with a defined cell)
# ----------------------------------------------------------------------------------
chosen_molecule_str = 'Fe'
edge_length = 9.37  # desired supercell edge length in Å
molecules_target = 128  # total number of molecules in the supercell
