...
if [ "$TI_mode" -eq 1 ]; then
    awk 'NR%2==0' xelist1 > xelist2
    # awk 'NR%2==0' xtlist1 > xtlist2
    # awk 'NR%2==0' xplist1 > xplist2
    awk 'NR%2==0' xflist1 > xflist2
...
if [ "$TI_mode" -eq 1 ]; then
    paste xelist2 xplist1 xflist2 xtlist1 xqlist1 | awk '{print $1,$2,$3,$4,$1*$3,$5,$6,($1-$5),($1-$5)*($1-$5),$7,$8,$9,$10}' > xlist1
else
...
echo "Free energy = " $F "+-" $sF "eV" >> analysis/peavg.out
