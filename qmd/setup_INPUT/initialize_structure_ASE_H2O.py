...
# ----------------------------------------------------------------------------------
# Create H2O Unit Cell (with a defined cell)
# ----------------------------------------------------------------------------------
chosen_molecule_str = 'H2O'
edge_length = 10.381  # desired supercell edge length in Å
molecules_target = 27  # total number of molecules in the supercell
